...
| --private-key arg <br> (=["RUI6MR...W5CV","5KQwrP...vFD3"]) | Tuple of [PublicKey, WIF private key] (may specify multiple times) |

debug_witness plug-in option

| Parameter | Explanation |
|:--- |:--- |
| --debug-private-key arg <br> (=["RUI6MR...W5CV","5KQwrP...vFD3"]) | Tuple of [PublicKey, WIF private key] (may specify multiple times) |
