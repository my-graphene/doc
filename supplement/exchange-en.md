...
Enter node directory, start MyGChain witness_node
...
If you don't have any account, downlod MyGChain light weighted wallet first or access online wallet to register an account\(Remember to back it up，save your private key properly\).
