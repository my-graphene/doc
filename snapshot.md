...
**程序可能会 更新，请**[**点击这里**](https://github.com/rui-coin/rui-core/releases/latest)**下载最新程序。**
...
上面的json文件中，每一行是一个json，其中id为对象id, 1.25.x为忠诚计划余额对象, 2.5.x为余额对象; 对象id文件参考[这里](https://github.com/rui-coin/rui-core/wiki/Objects-and-IDS)
